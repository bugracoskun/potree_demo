      ...
      open:function(id){
        ...
        if(that.sample.type=="cloud"){
            ...
            Potree.loadPointCloud("./pointclouds/vol_total/cloud.js", "sigeom.sa", e => {
                ...
                viewer.scene.view.position.set(590093.649, 231823.465, 267.402);
                viewer.scene.view.lookAt(new THREE.Vector3(589837.149, 231438.996, -0.707));
            ...
            /*
            viewer.loadProject("src/data/sample"+that.sample.id+"/sample"+that.sample.id+".json").then( (e) => {
